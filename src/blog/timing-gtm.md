...
1. Map the three to five trigger events that historically preceded your best deals
2. Build a detection system for those events across your ICP list
3. Route triggered accounts into a separate sequence with messaging specific to the state they're in, not the profile they match
